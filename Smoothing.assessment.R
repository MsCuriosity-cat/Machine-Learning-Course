...
# make the span two months long
tmp <- dat %>% group_by(day,month, year) %>% summarise(total_deaths = sum(deaths))
...
## mnist the x_2 variable is not significant
library(broom)
...
# fit a loess line and plot the results
mnist_27$train %>% 
